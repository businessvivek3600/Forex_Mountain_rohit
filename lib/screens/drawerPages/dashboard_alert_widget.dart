...
import 'package:forex_mountain/database/model/response/dashboard_alert_model.dart';
import 'package:forex_mountain/myapp.dart';
...
//scaffold messanger with message and a text contact us with rich tex and ontap
    ...
    Get.to(WebViewExample(
      ...
      showToast: '0',
      allowCopy: false,
      conditions: const ['https://ForexMountains.com/verify_document_responce'],
      onResponse: (res) async {
        ...
        if (success) {
          ...
          //   btnOkOnPress: () {
          //     bool? canPop = ForexMountains.navigatorKey.currentState?.canPop();
          //     logger.e('canPop is $canPop', tag: tag);
          //     if (canPop == true) {
          //       ForexMountains.navigatorKey.currentState?.pop();
          //     } else {
