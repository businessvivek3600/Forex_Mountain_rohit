  ...
  initialiseFields() async {
    ...
    await Future(() {
      ...
      if (u.countryCode != null) {
        // log('country code is ${authProvider.countriesList}');
        signUpCountry = sl
            .get<AuthProvider>()
            .countriesList
        ...
        //     log('${element.id?.length}   ' + '  ${u.country?.length}'));
        log('country code is ${u.countryCode}');
        log('country code is ${signUpCountry?.phonecode}');
      }
    ...
    return ListView(
      ...
      children: [
        ...
        IntlPhoneField(
          ...
          style: GoogleFonts.ubuntu(textStyle: const TextStyle(color: Colors.white)),
          decoration: const InputDecoration(hintText: 'Phone Number'),
          onChanged: (phone) => log(phone.completeNumber),
