...
class DrawerVideosMainPage extends StatefulWidget {
  const DrawerVideosMainPage({super.key});
        ...
        return Scaffold(
          ...
          body: SmartRefresher(
            ...
            child: provider.loadingVideos
                ? const Center(child: CircularProgressIndicator(color: appLogoColor))
...
class VimeoPlayerWidget extends StatefulWidget {
  const VimeoPlayerWidget({super.key, required this.url});
  final String url;
  @override
