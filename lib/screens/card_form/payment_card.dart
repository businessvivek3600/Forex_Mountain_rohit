  ...
  static Widget? getCardIcon(CardType? cardType) {
    ...
    switch (cardType) {
      ...
      case CardType.Others:
        icon = Icon(Icons.credit_card, size: 20.0, color: Colors.white);
        break;
      default:
        icon = Icon(Icons.warning, size: 20.0, color: Colors.white);
        break;
    }
    Widget? widget;
    if (img.isNotEmpty) {
      widget = assetImages('card_images/$img', width: 30.0);
    } else {
      widget = icon;
    }
    return widget;
  }
  static ImageProvider? getCardImageProvider(CardType? cardType) {
    String img = "";
    switch (cardType) {
      case CardType.Master:
        img = 'mastercard.png';
    ...
    ImageProvider? widget;
      widget = assetImageProvider('card_images/$img');
    return widget;
  }
