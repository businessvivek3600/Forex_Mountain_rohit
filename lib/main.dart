...
import 'package:forex_mountain/utils/device_info.dart';
...
class ErrorPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //           MaterialPageRoute(
      //               builder: (context) =>
      //                   forex_mountain(initialRoute: SplashScreen.routeName)),
      //           (route) => false);
      //     } catch (e) {
      //       errorLog(e.toString());
      //     }
...
Future<void> _crashlystics() async {
  ...
  //   try {
  //     // Navigator.pushAndRemoveUntil(
  //     //     forex_mountain.navigatorKey.currentContext!,
