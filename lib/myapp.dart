...
class ForexMountains extends StatefulWidget {
  const ForexMountains(
  ...
  @override
  State<ForexMountains> createState() => _ForexMountainsState();
}

class _ForexMountainsState extends State<ForexMountains> {
  late VideoPlayerController _controller;
  String tag = 'ForexMountains';
      ...
      child: MultiProvider(
        ...
        child: Builder(builder: (context) {
          return GetMaterialApp(
            navigatorKey: ForexMountains.navigatorKey,
