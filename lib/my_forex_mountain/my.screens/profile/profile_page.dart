        ...
        body: dashboardProvider.isLoading
            ...
            : ListView(
                ...
                children: [
                          ...
                          onTap: () {
                            Navigator.push(
                              ...
                              if (result == true) {
                                ...
                                Provider.of<MyDashboardProvider>(context,
                                        listen: false)
                  ...
                  Stack(
                    children: [
                      GlassCard(
                        ...
                        child: Column(
                          children: [
                            _infoRow(Iconsax.call, "Mobile",
                                customer.customerMobile),
                            _infoRow(Iconsax.calendar, "Date of Birth",
                                customer.dateOfBirth),
                            _infoRow(Iconsax.location, "City", customer.city),
                            _infoRow(Iconsax.home, "House No.",
                                customer.customerShortAddress ?? ""),
                            _infoRow(Iconsax.building, "Address 1",
                                customer.customerAddress1),
                            _infoRow(Iconsax.building, "Address 2",
                                customer.customerAddress2),
                            _infoRow(Iconsax.location_tick, "State",
                                customer.customerAddress2),
                            _infoRow(
                                Iconsax.global, "State", customer.countryText),
                            _infoRow(
                                Iconsax.code, "Zip Code", customer.zip ?? ""),
                          ],
                        ),
                      ),
                      Positioned(
                  ...
                  _buildGlassTile(
                      context, Iconsax.password_check, "Change Password", () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
