...
class _MyTeamViewScreenState extends State<MyTeamViewScreen> {
  ...
  void initState() {
    ...
    _scrollController.addListener(() {
      final provider = Provider.of<MyMlmProvider>(context, listen: false);
      if (_scrollController.position.pixels >=
          _scrollController.position.maxScrollExtent - 100) {
        provider.fetchMyTeamData(context, loadMore: true);
      }
    });
  }
              ...
              return RefreshIndicator(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    if (index == provider.teamMembers.length) {
                      return const Padding(
                        padding: EdgeInsets.all(20.0),
                        child: Center(child: CircularProgressIndicator()),
                      );
                    }
                    final user =provider.teamMembers[index];
