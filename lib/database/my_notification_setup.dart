          ...
          actions: <Widget>[
            CupertinoDialogAction(
              ...
              onPressed: () async {
                ...
                await ForexMountains.navigatorKey.currentState?.pushNamed(
        ...
        if (localUser != '') {
          ...
          if (routeName == YoutubePlayerPage.routeName) {
            if (data['isLive'] != null &&
              ...
              await ForexMountains.navigatorKey.currentState
                  ?.pushNamed(routeName, arguments: payload);
            } else {
              // await forex_mountain.navigatorKey.currentState
          ...
          // forex_mountain.navigatorKey.currentState
          //     ?.pushNamed(routeName, arguments: payload);
          // forex_mountain.navigatorKey.currentState?.pushNamed(
